...
class DiTBlock(nn.Module):
    ...
    def __init__(self, hidden_size, num_heads, mlp_ratio=4.0, gta=False, v_transform=False, resolutions=[16, 16], **block_kwargs):
        super().__init__()
        self.norm1 = nn.LayerNorm(
            hidden_size, elementwise_affine=False, eps=1e-6)
        self.attn = Attention(hidden_size, num_heads=num_heads, qkv_bias=True, qk_norm=True,
                              gta=gta, v_transform=v_transform, resolutions=resolutions, **block_kwargs)
...
class FinalLayer(nn.Module):
    ...
    def __init__(self, hidden_size, patch_size, out_channels, posdim=None):
        super().__init__()
    ...
    def __init__(
        ...
        self.blocks = nn.ModuleList([
            DiTBlock(hidden_size, num_heads, mlp_ratio=mlp_ratio,
                     gta=self.gta, v_transform=self.v_transform, resolutions=[input_size//patch_size, input_size//patch_size]) for _ in range(depth)
        ])
